...
pub const DEFAULT_STATE_CAPACITY: u64 = 100_000;
pub const DEFAULT_STATE_IDLE_SECONDS: u64 = 60 * 60;
...
impl Default for LimiterConfig {
    fn default() -> Self {
        Self {
            ...
            state_idle_seconds: DEFAULT_STATE_IDLE_SECONDS,
...
impl LimiterConfig {
    ...
    pub fn from_toml_str(toml_text: &str) -> Result<Self, ConfigError> {
        ...
        Ok(Self {
            ...
            state_capacity: bd.state_capacity.unwrap_or(DEFAULT_STATE_CAPACITY).max(1),
            state_idle_seconds: bd
                .state_idle_seconds
                .unwrap_or(DEFAULT_STATE_IDLE_SECONDS)
                .max(1),
