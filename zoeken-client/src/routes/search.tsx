...
function SearchPage() {
	...
	const categoriesList = PRIMARY_CATEGORIES.filter((category) =>
	...
	return (
		<div className="zoeken-serp min-h-dvh text-ink">
			...
			{query.data ? (
				<div className="animate-fade mx-auto max-w-6xl px-4 pt-6 pb-20 sm:px-6 sm:pl-[4.25rem]">
