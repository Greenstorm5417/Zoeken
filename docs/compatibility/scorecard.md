...
| Area | Status |
| --- | --- |
| Engines | intentionally-skipped=40, ported=248 (total 288) |
| Routes | partial=1, ported=21, rust-only=1 (total 23) |
| Data assets | missing=4, present=8, unknown-upstream=1 (total 13) |
| Lua plugins on disk | 11 (`ahmia_filter, calculator, hash, hostnames, infinite_scroll, oa_doi_rewrite, self_info, time_zone, tor_check, tracker_url_remover, unit_converter`) |
