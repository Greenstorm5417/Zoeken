...
| baidu | intentionally-skipped |  |  | online | yes | no | yes | no | no | no | not-applicable | bespoke regional engine not supported |
...
| duckduckgo_weather | intentionally-skipped |  | weather | online | no | no | no | yes | no | no | not-applicable | bespoke weather engine not supported |
...
| material_icons | intentionally-skipped |  | images, icons | online | no | no | no | no | no | no | not-applicable | bespoke icon engine not supported |
| mediathekviewweb | intentionally-skipped |  | videos | online | yes | no | no | no | no | no | not-applicable | bespoke regional video engine not supported |
...
| neosearch | intentionally-skipped |  | general | online | no | no | no | no | no | no | not-applicable | bespoke engine not supported |
...
| quark | intentionally-skipped |  |  | online | yes | no | yes | no | no | no | not-applicable | bespoke regional engine not supported |
...
| sqlite | ported | sqlite |  | offline | yes | no | no | no | no | no | present |  |
...
| youtube_noapi | intentionally-skipped |  | videos, music | online | yes | no | yes | no | no | no | not-applicable | bespoke YouTube scraper not supported |
